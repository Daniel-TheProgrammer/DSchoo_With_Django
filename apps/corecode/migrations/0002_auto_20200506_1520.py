# Generated by Django 3.8.10 on 2021-15-07 17:20
...
def default_site_config(apps, schema_editor):
    ...
    Config.objects.bulk_create([
        Config(key='school_name', value='DTP School'),
        Config(key='school_slogan', value='Code Daily'),
        Config(key='school_address', value='Buea, Cameroon'),
    ])

    Session = apps.get_model('corecode', 'AcademicSession')
    Session.objects.bulk_create([
        Session(name='2020/2021', current=True),
    ])
    ...
    StudentClass.objects.bulk_create([
        StudentClass(name='Form 1'),
        StudentClass(name='Form 2'),
    ])
